...
// Demo credentials match the seed data created by the backend's DataInitializer.
// Set VITE_ENABLE_DEMO_LOGIN=false to strip them (and the quick-login UI) from a build.
